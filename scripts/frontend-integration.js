 ...
 * This file demonstrates how to integrate Vaultnode with a web frontend
 */

// For React/Vue/Angular applications
export class VaultnodeClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new VaultnodeClient(provider, contractAddress);
